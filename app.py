    ...
    try:
        ...
        try:
            ...
            if selected_term and selected_academic_year:
                ...
                if not has_marks:
                    # New academic year/term - start with empty student list
                    students = []
                    print(f"New academic year/term detected: {selected_academic_year} {selected_term} - starting with empty student list")
...
def api_get_rankings():
    ...
    try:
        ...
        rankings = db.get_student_rankings(form_level, term, academic_year, school_id)
